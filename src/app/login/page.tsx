    ...
    <div className="min-h-screen bg-[#080c14] text-white flex items-center justify-center px-4 py-10 sm:px-6">
      ...
      >
        <motion.div variants={itemVariants} className="mb-8 text-center sm:mb-9">
          ...
          <p className="mt-2 text-base text-gray-400 sm:text-lg">Entre na sua conta</p>
        </motion.div>
        ...
        >
          Não tem conta?{' '}
          <a href="/cadastro" className="font-medium text-emerald-300 transition-colors hover:text-emerald-200 hover:underline">
            Criar conta
          </a>
        </motion.p>
      </motion.div>
